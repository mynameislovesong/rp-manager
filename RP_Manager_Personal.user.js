...
`;
  ...
  function applySelectedExtraLibraryToRoom(room, selectedItems) {
    ...
    const byId = new Map(
... 131401 bytes omitted ...
" id="rpcm-detached-expand">전체 펼치기</button>
  ...
  function addAiSummaryStyles() {
    GM_addStyle(`
      ...
      .rpcm-chatgpt-launchbar{flex-wrap:wrap}.rpcm-chatgpt-launchbar>div{flex:1 1 280px}.rpcm-chatgpt-settings{border-color:#3e5165;background:#19212a}.rpcm-current-state-reminder{display:flex;align-items:center;gap:8px;width:100%;box-sizing:border-box;margin:0 0 6px;padding:7px 10px;border:1px solid #3e7184;border-radius:9px;background:linear-gradient(90deg,#12232c,#17212a);color:#d7edf5;box-shadow:0 5px 18px rgba(0,0,0,.24);font:11px/1.35 -apple-system,BlinkMacSystemFont,"Pretendard",sans-serif;pointer-events:auto}.rpcm-current-state-reminder>span{min-width:0;flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.rpcm-current-state-reminder strong{color:#83d8ee}.rpcm-current-state-reminder button{flex:0 0 auto;border:1px solid #4a8194;border-radius:7px;background:#1c3a47;color:#e5f8fd;padding:5px 9px;font:inherit;font-weight:800;cursor:pointer}.rpcm-current-state-reminder button.close{border:0;background:transparent;color:#8eacb6;padding:3px 5px;font-size:18px;line-height:1}
      ...
      <div id="rpcm-modal-wrap">
        <div id="rpcm-modal" class="${uiPrefs.density === 'compact' ? 'rpcm-density-compact' : ''}">
          ...
          <div class="rpcm-body">
            ...
            <div class="rpcm-ai-launchbar rpcm-chatgpt-launchbar">
